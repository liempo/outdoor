...
package com.liempo.outdoor.tensorflow.tracking;
...
import com.liempo.outdoor.tensorflow.tflite.Classifier.Recognition;
  ...
  private void processResults(final List<Recognition> results) {
    ...
    for (final Recognition result : results) {
      ...
      if (detectionFrameRect.width() < MIN_SIZE || detectionFrameRect.height() < MIN_SIZE) {
        Timber.w("Degenerate rectangle! %s", detectionFrameRect);
        continue;
      }
